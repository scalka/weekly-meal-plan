function TermsOfUse() {
  return (
    <main>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Weekly meal planner.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            <a
              href="https://www.freeTermsOfUse.com/free-terms-and-conditions-generator/"
              target="_blank"
              rel="noreferrer"
            >
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Weekly meal planner, accessible
            from{' '}
            <a
              href="https://weekly-meal-planner.vercel.app/"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://weekly-meal-planner.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: calka.sylwia@gmail.com</li>
      </ul>
    </main>
  );
}
